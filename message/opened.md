...
5. Please note that spamming your pull request number in the Discord server will get your pull request marked as "low priority". The same for mentioning other maintainers using "@" or making duplicate pull requests.
